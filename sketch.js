...
function preload(){
  ...
  blue_balloonImage = loadImage("blue_ballong0.png");
...
function blueBalloon() {
  ...
  var blue = createSprite(0,Math.round(random(50,270)), 10, 10);
...
function greenBalloon() {
  //crieSprite para o balão
  var green = createSprite(0,Math.round(random(35,130)), 10, 10);
...
function pinkBalloon() {
 //crieSprite para o balão
 var pink = createSprite(0,Math.round(random(70,200)), 10, 10);
